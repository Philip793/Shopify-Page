      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-4">
              Founded in 2020, Magestic began as a small family-run business
              with a simple belief: board games have the power to bring people
              together in ways that digital entertainment cannot.
            </p>
            <p className="text-gray-600 mb-4">
              What started as a passion project in our living room quickly grew
              into a mission to share the joy of board gaming with families
              across Australia. We carefully curate each game in our collection,
              ensuring it meets our high standards for quality, engagement, and
              fun.
            </p>
            <p className="text-gray-600">
              Today, Magestic stands as a testament to the enduring appeal of
              face-to-face gaming, offering a carefully selected range of games
              that create lasting memories and strengthen family bonds.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <div className="bg-white rounded-lg shadow-md p-6 text-center">
            ...
            <p className="text-gray-600">
              Every game in our collection is personally tested and approved by
              our team of gaming enthusiasts.
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 text-center">
            ...
            <p className="text-gray-600">
              We support local gaming groups and events to build a vibrant board
              gaming community.
            </p>
          </div>
        </div>
