          ...
          <div className="prose max-w-none">
            ...
            <div className="mb-8">
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                <ul className="space-y-2 text-gray-700">
                  ...
                  <li>
                    <strong>Standard Delivery:</strong> 5-7 business days after
                    processing
                  </li>
                  <li>
                    <strong>Express Delivery:</strong> 2-3 business days after
                    processing
                  </li>
                  <li>
                    <strong>International:</strong> Currently not available
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                ...
                email. You can track your package using the carrier's website or
                through your account on our website.
              </p>
              <div className="bg-gold-50 rounded-lg p-4">
                <p className="text-burgundy-700">
                  <strong>Tip:</strong> Track your package regularly to ensure
                  you're available for delivery.
                </p>
              </div>
            </div>
            ...
            <div className="mb-8">
              ...
              <ul className="list-disc list-inside text-gray-700 space-y-2">
                ...
                <li>
                  PO Boxes and APO addresses are not eligible for express
                  shipping
                </li>
