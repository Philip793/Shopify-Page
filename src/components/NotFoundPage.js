  ...
  return (
    <div className="min-h-screen bg-gold-50 flex flex-col justify-center items-center px-4">
      <div className="text-center max-w-md">
        ...
        {/* Error Message */}
        <h1 className="text-4xl font-bold text-burgundy-900 mb-4">Page Not Found</h1>
        ...
        {/* Helpful Links */}
        <div className="mt-12">
          <h2 className="text-lg font-semibold text-gray-800 mb-4">Looking for something?</h2>
        ...
        <div className="mt-8 p-4 bg-white rounded-lg shadow-sm">
          <p className="text-sm text-gray-600">
            Need help? <Link to="/contact" className="text-burgundy-600 hover:text-burgundy-800 font-semibold">Contact our support team</Link>
          </p>
        </div>
      </div>
    </div>
