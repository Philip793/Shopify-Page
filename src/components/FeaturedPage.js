    ...
    <>
      ...
      <main className="min-h-screen bg-gray-50 py-16">
        <header className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gold-600 font-semibold-4">Featured Products</h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Discover our handpicked selection of most popular and highly-rated board games. 
            These customer favorites are perfect for any occasion.
          </p>
        </header>
          ...
          {featuredProducts.map((product) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 mb-4 text-sm line-clamp-3">{product.description?.replace(/\*\*/g, '').slice(0, 120)}...</p>
