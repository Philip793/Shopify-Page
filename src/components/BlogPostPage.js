  ...
  const blogPosts = [
    {
      ...
      `,
      date: "March 15, 2024",
      image: "https://images.unsplash.com/photo-1611997223036-302c7758526c?w=1200&h=600&fit=crop",
      category: "Trends",
      readTime: "5 min read",
      author: "Sarah Johnson",
      tags: ["board games", "digital detox", "family time", "social connection"]
    },
    {
      id: 2,
      ...
      `,
      date: "March 10, 2024",
      image: "https://images.unsplash.com/photo-1596435084672-12f674b677b1?w=1200&h=600&fit=crop",
      category: "Reviews",
      readTime: "8 min read",
      author: "Mike Chen",
      tags: ["strategy games", "family games", "game recommendations", "reviews"]
    },
    {
      id: 3,
      ...
      tags: ["child development", "educational games", "parenting", "learning through play"]
    },
    {
      id: 4,
      ...
      image: "https://images.unsplash.com/photo-1528360983277-3d33e4e2e1f1?w=1200&h=600&fit=crop",
      category: "Guides",
      readTime: "7 min read",
      author: "Alex Thompson",
      tags: ["game collection", "board game storage", "family games", "game recommendations"]
    },
    {
      id: 5,
    ...
    },
    {
      ...
      tags: ["age-appropriate games", "family games", "game recommendations", "parenting"]
    }
  ];
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <nav className="mb-8">
            <ol className="flex items-center space-x-2 text-sm text-gray-600">
              <li><Link to="/" className="hover:text-burgundy-600">Home</Link></li>
              <li>/</li>
              <li><Link to="/blog" className="hover:text-burgundy-600">Blog</Link></li>
              <li>/</li>
          ...
          <section className="mt-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {blogPosts
                ...
                .slice(0, 3)
                .map(relatedPost => (
                  <article key={relatedPost.id} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-shadow cursor-pointer" onClick={() => navigate(`/blog/${relatedPost.id}`)}>
                    ...
                    <div className="p-6">
                      ...
                      <p className="text-sm text-gray-500 mb-3">{relatedPost.readTime}</p>
