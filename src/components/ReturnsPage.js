          ...
          <div className="prose max-w-none">
            <div className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                At Magestic, we want you to be completely satisfied with your
              ...
              <div className="space-y-4">
                <div className="border-l-4 border-burgundy-500 pl-4">
                  ...
                  <p className="text-gray-600 text-sm">
                    Email support@magestic.com.au with your order number
                  </p>
                </div>
                <div className="border-l-4 border-burgundy-500 pl-4">
                  <h3 className="font-semibold text-gray-800">
                ...
                <div className="border-l-4 border-burgundy-500 pl-4">
                  ...
                  <p className="text-gray-600 text-sm">
                    Pack items securely and attach the return label
                  </p>
                </div>
                <div className="border-l-4 border-burgundy-500 pl-4">
                  <h3 className="font-semibold text-gray-800">
            ...
            <div className="mb-8">
              ...
              <ul className="list-disc list-inside text-gray-700 space-y-2">
                <li>
                  <strong>Original Payment Method:</strong> Full refund to
                  original payment method
                </li>
                <li>
                  <strong>Store Credit:</strong> 10% bonus credit for future
                  purchases
                </li>
                <li>
                  <strong>Exchange:</strong> Direct exchange for different item
                  of equal value
                </li>
              </ul>
            </div>
            ...
            <div className="bg-gold-50 rounded-lg p-6">
              ...
              <p className="text-burgundy-700">
                For any return-related questions, contact our customer service
                team at
                <a
                  href="mailto:support@magestic.com.au"
                  className="text-burgundy-600 underline ml-1"
                >
