    ...
    <footer className="bg-burgundy-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mt-12 pt-8 border-t border-burgundy-700">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <form onSubmit={handleSubscribe} className="flex space-x-2">
              ...
              <button
                type="submit"
                className="px-6 py-2 bg-burgundy-600 text-white rounded-md hover:bg-burgundy-500 transition-colors font-semibold"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="mt-8 pt-8 border-t border-burgundy-700 text-center">
          <p className="text-white">2024 Magestic. All rights reserved.</p>
        </div>
      </div>
