  ...
  const blogPosts = [
    {
      ...
      excerpt: "Discover tips and tricks for hosting the perfect board game night with friends and family.",
      date: "March 15, 2024",
    ...
    },
    {
      ...
      excerpt: "New to board games? Start with these amazing strategy games that are perfect for newcomers.",
      date: "March 10, 2024",
      image: "https://images.unsplash.com/photo-1552519507-da3b142c6e3d?w=400&h=300&fit=crop"
    },
    {
      ...
      excerpt: "Explore the resurgence of board games in the digital age and their benefits for social connection.",
      date: "March 5, 2024",
      image: "https://images.unsplash.com/photo-1552519507-da3b142c6e3d?w=400&h=300&fit=crop"
    }
  ];
    ...
    <section className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-burgundy-900 mb-4">Latest from Our Blog</h2>
          ...
          {blogPosts.map((post) => (
            <article key={post.id} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-shadow">
              ...
              <div className="p-6 bg-gradient-to-br from-gold-100 to-gold-200">
                <div className="text-sm text-burgundy-800 font-semibold mb-2">{post.date}</div>
