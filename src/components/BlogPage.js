...
const BlogPage = () => {
  ...
  const structuredData = {
    ...
    description:
      "Stay updated with the latest board game trends, reviews, and gaming tips from our experts at Magestic.",
  ...
  const blogPosts = [
    {
      ...
      date: "March 15, 2024",
      image:
        "https://images.unsplash.com/photo-1611997223036-302c7758526c?w=800&h=400&fit=crop",
      category: "Trends",
      readTime: "5 min read",
    },
    {
      ...
      date: "March 10, 2024",
      image:
        "https://images.unsplash.com/photo-1596435084672-12f674b677b1?w=800&h=400&fit=crop",
      category: "Reviews",
      readTime: "8 min read",
    },
    {
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1528360983277-3d33e4e2e1f1?w=800&h=400&fit=crop",
      category: "Guides",
      readTime: "7 min read",
    },
    {
    ...
    <>
      ...
      <main className="min-h-screen bg-gray-50 py-16">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Recent Posts Grid */}
          <section>
            <h2 className="text-2xl font-bold text-burgundy-800 mb-8">
              Recent Posts
            </h2>
          ...
          <section className="mt-16 bg-burgundy-900 text-white rounded-lg p-8 text-center">
            ...
            <p className="mb-6">
              Get the latest blog posts and exclusive content delivered to your
              inbox.
            </p>
